				...
				<div class="tabs-container">
					...
					<ul role="tablist" class="nav nav-tabs">
						<li role="presentation">
							<a href="javascript:void(0);"><strong style="color:black;">Video:</strong></a>
						</li>
						<li role="presentation" class="active">
							<a href="#tab1" data-toggle="tab"><?=(!is_null($item) && !is_null($item->item_key) ? $item->item_key : "Nou");?></a>
						</li>
					</ul>
													...
													<div class="panel-group">
														...
														<div class="row">
															<div class="form-group">
																<label class="col-sm-2 control-label"><span style="border-bottom:2px solid #1c84c6;color:black;"><i class="fa fa-star" style="color:#1c84c6"></i> Publica video&nbsp;</span></label>
																<div class="col-sm-10">
																	<?php if(is_null($links)): echo "Nu s-au gasit legaturi"; ?>
																	<?php elseif(!is_null($links)): ?>
																	<select multiple data-placeholder="Acest video nu este disponibil publicului" class="chosen-sl-links" style="width:350px;" tabindex="4">
																	...
																	<span class="help-block m-b-none">Pentru a publica acest Video, selecteaza din lista de mai sus destinatia dorita!</span>
																	<?php endif; ?>
																</div>
															</div>
														</div>
														...
														<div class="row">
															<div class="form-group">
																<label class="col-sm-2 control-label">Se creaza video</label>
																<div class="col-sm-10">
																	<input type="text" placeholder="Creare video" class="form-control" name="<?=$form->item->prefix;?>item_key" value="<?=(!is_null($last_id) ? 'NR_CRT_' .$last_id : "");?>" readonly>
																</div>
															</div>
														</div>	
														<?php endif; ?>
														...
														<div class="row">
															<div class="form-group">
																<label class="col-sm-2 control-label">Nume video</label>
																<div class="col-sm-10">
																	<input type="text" placeholder="Poate fi o descriere scurta a video-ului(nu este obligatoriu)" class="form-control" name="<?=$form->item->prefix;?>item_name" value="<?=(!is_null($item) && !is_null($item->item_name) ? $item->item_name : "");?>">
																</div>
															</div>
														</div>
														...
														<div class="row">
															<div class="form-group">
																<label class="col-sm-2 control-label">Video cod(adresa video-ului)</label>
																<div class="col-sm-10">
																	<input type="text" placeholder="Adresa embed al Video-ului" class="form-control" name="<?=$form->item->prefix;?>item_videocode" value="<?=(!is_null($item) && !is_null($item->item_videocode) ? htmlspecialchars($item->item_videocode) : "");?>">
																</div>
															</div>
														</div>	
																	...
																	<div class="col-lg-2 col-md-4 col-xs-6 col-xs-12 thumb-nomg">
																		<div class="img-thumbnail-btn">
																			<button type="button" class="btn btn-primary btn-fill btn-upfile" data-toggle="modal" data-target="#inpfileModal" onClick="filesetvars('poza', 'poza')">
																				Incarca imagine <br /> Reprezentativa Video-ului<br/><br/><i class="fa fa-picture-o fa-2x" aria-hidden="true"></i>
																			</button>
																		</div>
																	</div>
																</div>
														...
														<fieldset>
																<div class="form-group">
																	<div class="col-sm-12">
																		<button class="btn btn-white" type="button" onClick="location.href='<?=base_url()?>galerie_video'">Anuleaza</button>
