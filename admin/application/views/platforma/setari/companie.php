	        						...
	        						<div id="tcompanie" class="tab-pane active">
												<div class="panel-body">
													<div class="row">
														...
														<div class="col-md-4">
															<div class="form-group">
																<label>Titlu companie</label>
																<input type="text" name="<?=$form->item->prefix;?>titlucompanie" class="form-control" placeholder="Titlul Companiei" value="<?=(!is_null($owner->titlucompanie) ? $owner->titlucompanie : "");?>">
															</div>
														</div>
													</div>
												...
												<div class="panel-body">
													...
													<h3 class="no-margins" style="font-weight:bold;color:#1c84c6;">
														...
														<div class="col-md-6">
															<div class="form-group">
																<label>Nume</label>
																<input type="text" name="<?=$form->item->prefix;?>pc_nume" class="form-control" placeholder="Nume" value="<?=(!empty($company->pc_nume) ? $company->pc_nume : '');?>">
															</div>
														</div>
														<div class="col-md-6">
															<div class="form-group">
																<label>Prenume</label>
																<input type="text" name="<?=$form->item->prefix;?>pc_prenume" class="form-control" placeholder="Prenume" value="<?=(!empty($company->pc_prenume) ? $company->pc_prenume : '');?>">
															</div>
														</div>
													</div>
													<div class="row">
														...
														<div class="col-md-6">
															<div class="form-group">
																<label for="exampleInputEmail1">Nr. telefon</label>
																<input type="text" name="<?=$form->item->prefix;?>pc_telefon" class="form-control" placeholder="Nr. telefon" value="<?=(!empty($company->pc_telefon) ? $company->pc_telefon : '');?>">
															</div>
														</div>
														...
														<div class="col-md-6">
															<div class="form-group">
																...
																<input type="email" name="<?=$form->item->prefix;?>pc_email" class="form-control" placeholder="E-mail" value="<?=(!empty($company->pc_email) ? $company->pc_email : '');?>">
															</div>
														</div>
