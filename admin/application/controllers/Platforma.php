						...
						switch($this->uriseg->item)
						{
							case UPDATE:
								...
								if(isset($_REQUEST["{$form_submit}"])) {
									...
									$newDBPattern_OWNER->design["initial"] = false;
									...
									if($update_owner || $update_company) $this->_Session->setFB_Pozitive(array("ref" => "Contul meu", "text" => "Modificarile tale au fost salvate!"));
